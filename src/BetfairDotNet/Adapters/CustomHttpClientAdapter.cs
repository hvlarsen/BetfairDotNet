...
public sealed class CustomHttpClientAdapter : IHttpClient
{
    private readonly HttpClient _httpClient;
    private readonly HttpClientHandler _httpClientHandler;

    public CustomHttpClientAdapter(string apiKey, string sessionToken, int timeoutMs)
    {
        _httpClientHandler = CreateClientHandler();
        _httpClient = CreateHttpClient(_httpClientHandler, apiKey, sessionToken, timeoutMs);
    }
    ...
    private static HttpClient CreateHttpClient(HttpMessageHandler handler, string apiKey, string sessionToken, int timeoutMs)
    {
        ...
        httpClient.DefaultRequestHeaders.Add("X-Authentication", sessionToken);
