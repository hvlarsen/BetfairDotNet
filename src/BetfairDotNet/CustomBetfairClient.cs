...
{
    public class CustomBetfairClient : IBetfairClient
    {
        ...
        /// </summary>
        public CustomBetfairClient(string apiKey, string sessionToken)
        {
            // Shared services
            var httpClient = new CustomHttpClientAdapter(apiKey, sessionToken, 5000);
